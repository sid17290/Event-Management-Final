...
const Home = () => {
  ...
  return (
    <div className='md:mx-[10vw] md:mb-8'>
      ...
      <div className='mt-10'>
        <h3 className='text-white text-lg font-semibold text-left ml-3 md:ml-14 mb-1'>Upcoming Events</h3>
      ...
      {/* societies carousel */}
      <div>
        <h3 className='text-white text-lg font-semibold text-left ml-3 md:ml-14'>Societies</h3>
