    ...
    <div className={`max-w-[200px] relative border rounded-xl p-4 flex flex-col gap-2 items-center justify-center ${isSelected?'border-red-700' : 'border-[#FFFFFF26]'}`}>
                ...
                <div className='w-full'>
                   <div className='group relative'>
                        <h1 className={`text-white text-md font-roboto font-medium md:truncate ${society?.name.length > 17? 'md:text-lg' : 'md:text-2xl'}`}>{society?.name}</h1>
                        {/* hover tooltip */}
                ...
                <div className='flex gap-3 justify-start w-full flex-col md:flex-row'>
