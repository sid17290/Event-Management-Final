...
function Main_slide(props){
  return (
    <div className='h-[35rem] mx-0'>
      ...
      <a href={data.at(props).registration_link} className='main-carousel-reg-btn max-md:hidden rounded bg-neutral-900 z-1 opacity-80 border text-white border-white top-1 float-right right-1 mt-[28rem] mr-[5rem] px-12 py-2'>Register</a>
